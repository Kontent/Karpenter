...
window.addEvent('domready',function(){
	...
	$$('.socializer').addEvent('click',function(e){
		...
		closeme.src="../img/socialize/close.gif";
		...
		img.src = '../img/socialize/blinklist.png';
		...
		img.src = '../img/socialize/bookmark.gif';
		img.injectInside(left);
		...
		img.src = '../img/socialize/delicious.png';
		img.injectInside(left);
		...
		img.src = '../img/socialize/digg.png';
		img.injectInside(left);
		...
		img.src = '../img/socialize/furl.png';
		img.injectInside(left);
		...
		img.src = '../img/socialize/reddit.png';
		img.injectInside(left);
		...
		img.src = '../img/socialize/feedmelinks.png';
		img.injectInside(left);
		...
		img.src = '../img/socialize/technorati.png';
		img.injectInside(left);
		...
		img.src = '../img/socialize/im_yahoo.gif';
		img.injectInside(left);
		...
		img.src = '../img/socialize/tipd.gif';
		img.injectInside(left);
		...
		img.src = '../img/socialize/netvouz.png';
		img.injectInside(left);
		...
		img.src = '../img/socialize/rojo.png';
		img.injectInside(left);
		...
		img.src = '../img/socialize/shadows.png';
		img.injectInside(left);
		...
		img.src  = '../img/socialize/oneview.gif';
		img.injectInside(left);
		...
		img.src = '../img/socialize/dzone.png';
		...
		img.src = '../img/socialize/newsvine.png';
		img.injectInside(right);
		...
		img.src = '../img/socialize/magnolia.png';
		img.injectInside(right);
		...
		img.src = '../img/socialize/stumbleupon.png';
		img.injectInside(right);
		...
		var img = new Element('img');
		img.alt = 'send to google';
		img.src = '../img/socialize/google.png';
		img.injectInside(right);
		...
		img.src = '../img/socialize/squidoo.png';
		img.injectInside(right);
		...
		img.src = '../img/socialize/spurl.png';
		img.injectInside(right);
		...
		img.src = '../img/socialize/blinkbits.png';
		img.injectInside(right);
		...
		img.src = '../img/socialize/bmarks.png';
		img.injectInside(right);
		...
		img.src = '../img/socialize/bloglines.png';
		img.injectInside(right);
		...
		img.src = '../img/socialize/comments.png';
		img.injectInside(right);
		...
		img.src = '../img/socialize/scuttle.png';
		img.injectInside(right);
		...
		img.src = '../img/socialize/slashdot.png';
		img.injectInside(right);
	...
	//	}).start(0,1);	
		...
		$$('.soc_left a').addEvent('click',function(e){
			...
			closeX.src = "../img/socialize/close.gif";
